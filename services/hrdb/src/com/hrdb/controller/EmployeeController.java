...
public class EmployeeController {
    ...
    @RequestMapping(value="/{id:.+}/vacationbyEmpids", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the vacationbyEmpids instance associated with the given id.")
     public Page<Vacation> findAssociatedvacationbyEmpids(Pageable pageable, @PathVariable("id") Integer id){
        LOGGER.debug("Fetching all associated vacationbyEmpids");
        return vacationService.findAssociatedValues(id,"vacationbyEmpid","eid", pageable);
   }

    @RequestMapping(value="/{id:.+}/employeebyManagerids", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the employeebyManagerids instance associated with the given id.")
     public Page<Employee> findAssociatedemployeebyManagerids(Pageable pageable, @PathVariable("id") Integer id){
        LOGGER.debug("Fetching all associated employeebyManagerids");
