...
public class DepartmentController {
    ...
    @RequestMapping(value="/{id:.+}/employeebyDeptids", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the employeebyDeptids instance associated with the given id.")
     public Page<Employee> findAssociatedemployeebyDeptids(Pageable pageable, @PathVariable("id") Integer id){
        LOGGER.debug("Fetching all associated employeebyDeptids");
        return employeeService.findAssociatedValues(id,"employeebyDeptid","deptid", pageable);
   }
